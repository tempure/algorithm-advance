...
* @Description: 1107. 魔板
* @Author: Xiaobin Ren
* @Date:   2020-10-15 23:19:12
* @Last Modified time: 2020-10-15 23:19:26
*/
#include <iostream>
#include <algorithm>
#include <cstring>
...
unordered_map<string, pair<char, string> > pre; //从哪个状态转移过来的，操作用char存储
queue<string> q;
...
int main(){
    ...
    for(int i = 0 ; i < 8; i++){
        cin >> x;
        end += char(x + '0'); //将数字转为char 然后拼接到string
    }
